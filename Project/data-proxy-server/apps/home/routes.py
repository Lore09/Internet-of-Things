...
"""
from apps import registered_devices, mqtt_client, write_api, config
...
def get_sensor_data():
    ...
    try:
        ...
        write_api.write(config.get("INFLUXDB_BUCKET"), config.get("INFLUXDB_ORG"), request.form.to_dict())
